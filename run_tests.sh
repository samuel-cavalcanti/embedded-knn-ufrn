...
avr-gcc knn/chosen/chosen.c knn/chosen/chosen.h  knn/knn.c knn/knn.h dataset/dataset.h main.c -lm hardware_abstraction_layer/hardware_abstraction_layer.h hardware_abstraction_layer/arduino_uno.c -o avr_test
rm avr_test
